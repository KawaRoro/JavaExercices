...
// Todo
// Boucle pour la récupération de fichiers
// Correcteur orthographique
// Gérer la ponctuation
// Gérer les caractères avec apostrophes
// Gérer les caractères en majuscule et en minuscule
	...
	public static void main(String[] args)throws Exception 
	{
		  ...
		  Scanner sc = new Scanner(System.in);
			...
			for(int i = 0; i < tabTrad.length ; i++ ) {
				if(id_langue != i) {
					for(int k = 0; k < (message.length) ; k++ ) {
						int var_id_tmp = message_to_id[k]; // Récupére l'identifiant du mot dans la liste de mot fr / en ...
